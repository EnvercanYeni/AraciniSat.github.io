...
//    echo "<th>" . $row["islemler"] . "</th>";
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<tr>
							...
							<td>" . $row["fiyat"]. "</td>  ;
							<td><a href='silotomobil.php?id=" . $row["id"] . "'><button class='sil'>Sil</button></a><a href='guncelleotomobil.php?id=" . $row["id"] . "'><button class='guncelle'>Güncelle</button></a></td>;
	  ...
	  <a href="otomobilekle.php"><button href="otomobilekle.php" class="ekle" >Otomobil Ekle</button></a>
