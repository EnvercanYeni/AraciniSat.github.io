<?php
include('baglan.php');
$duzenle=mysqli_query($conn,"SELECT * FROM motosiklet WHERE id=".$_GET['id']);
...
if ($_POST) {
  ...
  if ($_FILES["resim"]["name"]) {
    ...
    $update_query = "UPDATE motosiklet SET marka='$marka', model='$model', renk='$renk', km='$km', resim='$image_path', fiyat='$fiyat' WHERE id=".$_GET['id'];
  } else {
    $update_query = "UPDATE motosiklet SET marka='$marka', model='$model', renk='$renk', km='$km', fiyat='$fiyat' WHERE id=".$_GET['id'];
  }
