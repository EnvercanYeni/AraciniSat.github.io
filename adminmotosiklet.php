...
//    echo "<th>" . $row["islemler"] . "</th>";
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    echo "<tr>
							...
							<td>" . $row["fiyat"]. "</td>  ;
							<td><a href='silmotosiklet.php?id=" . $row["id"] . "'><button class='sil'>Sil</button></a><a href='guncellemotosiklet.php?id=" . $row["id"] . "'><button class='guncelle'>Güncelle</button></a></td>;
	  ...
	  <a href="motosikletekle.php"><button href="motosikletekle.php" class="ekle" >Motosiklet Ekle</button></a>
